        ...
        {packages.map((pkg) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <button   onClick={() => handlePackageClick(pkg.id)} className="bg-gradient-to-r from-blue-600 to-teal-500 text-white py-3 px-8 rounded-lg shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-teal-600 hover:shadow-2xl">
                View Packages
              </button>
            </div>
          </div>
