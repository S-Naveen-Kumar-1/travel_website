...
import banner from "../../src/assets/bannerTravel.jpg";
  ...
  return (
    ...
    >
      <section className="lg:h-full flex flex-col justify-center items-center text-center p-8 z-10">
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 bg-white bg-opacity-80 p-6 rounded-lg flex flex-wrap justify-center items-center gap-6 max-w-4xl w-11/12 sm:bottom-8 xs:bottom-6">
